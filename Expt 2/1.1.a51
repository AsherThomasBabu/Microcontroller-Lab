;Write an assembly language program(ALP) to multiply two 8 bit numbers stored in two adjacent memory locations and store the result in two adjacent memory locations.
